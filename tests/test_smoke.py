...
def test_smoke():
    ...
    ranks = cost_based_methods.multi_JMI(
        X=X_train, y=y_train, is_disc=is_discrete, cost_vec=average_costs,
    ...
    avg_accuracy, std_accuracy, total_cost, prop_noise = \
        cost_based_analysis.accuracy_classifier_plot(
            dfPen_Ranking=ranks, X_val=X_val, y_val=y_val, cost_vec=average_costs,
