...
dfModIndex = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/modIndex_10000sim_1000nodes_DMC_DMR.csv'))
dfSummaries = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/summaries_10000sim_1000nodes_DMC_DMR.csv'))
dfIsDisc = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/isDisc_10000sim_1000nodes_DMC_DMR.csv'))
dfTimes = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/times_10000sim_1000nodes_DMC_DMR.csv'))
...
#loc_data = ''
#dfModIndex = pd.read_csv(filepath_or_buffer = loc_data+'modIndex_10000sim_1000nodes_DMC_DMR.csv')
#dfSummaries = pd.read_csv(filepath_or_buffer = loc_data+'summaries_10000sim_1000nodes_DMC_DMR.csv')
#dfIsDisc = pd.read_csv(filepath_or_buffer = loc_data+'isDisc_10000sim_1000nodes_DMC_DMR.csv')
#dfTimes = pd.read_csv(filepath_or_buffer = loc_data+'times_10000sim_1000nodes_DMC_DMR.csv')
...
# Gride of penalization parameters for which the rankings will be computed
grid_cost_param = list(np.arange(0, 100, 0.02))
# Gride for the weighted random forest methods
...
avg_accuracy_reliefF_classic_knn, std_accuracy_reliefF_rf_knn, total_cost_reliefF_rf_knn, prop_noise_reliefF_rf_knn = cost_based_analysis.accuracy_classifier_plot(dfPen_Ranking = dfRank_reliefF_rfprox,
                                                                                                                                                                   ...
                                                                                                                                                                   classifier_func = classifier,
                                                                                                                                                                   args_classifier = dict_args,
                                                                                                                                                                   num_fold = 3, save_name = "evol_reliefF_rf_kNN_DMC_DMR.pdf",
                                                                                                                                                                   random_seed = 123)
