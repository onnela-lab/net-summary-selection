...
dfModIndex_small = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/modIndex_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv'))
dfSummaries_small = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/summaries_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv'))
dfIsDisc_small = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/isDisc_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv'))
dfTimes_small = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/times_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv'))

dfModIndex_large = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/modIndex_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv'))
dfSummaries_large = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/summaries_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv'))
dfIsDisc_large = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/isDisc_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv'))
dfTimes_large = pd.read_csv(filepath_or_buffer = resource_filename('cost_based_selection', 'data/times_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv'))
...
#loc_data = ''
#
#dfModIndex_small = pd.read_csv(filepath_or_buffer = loc_data+'modIndex_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv')
#dfSummaries_small = pd.read_csv(filepath_or_buffer = loc_data+'summaries_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv')
#dfIsDisc_small = pd.read_csv(filepath_or_buffer = loc_data+'isDisc_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv')
#dfTimes_small = pd.read_csv(filepath_or_buffer = loc_data+'times_10000sim_'+str(small_size)+'nodes_DMC_DMR.csv')
#
#dfModIndex_large = pd.read_csv(filepath_or_buffer = loc_data+'modIndex_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv')
#dfSummaries_large = pd.read_csv(filepath_or_buffer = loc_data+'summaries_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv')
#dfIsDisc_large = pd.read_csv(filepath_or_buffer = loc_data+'isDisc_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv')
#dfTimes_large = pd.read_csv(filepath_or_buffer = loc_data+'times_10000sim_'+str(large_size)+'nodes_DMC_DMR.csv')
